...
void ziti_ctrl_extend_cert_authenticator(ziti_controller *ctrl, char *authenticatorId, char *csr, void(*cb)(ziti_extend_cert_authenticator_resp*, const ziti_error *, void *), void *ctx) {
    if(!verify_api_session(ctrl, cb, ctx)) return;
    ...
    NEWP(extend_req, ziti_extend_cert_authenticator_req);
...
void ziti_ctrl_verify_extend_cert_authenticator(ziti_controller *ctrl, char *authenticatorId, char *client_cert, void(*cb)(void *, const ziti_error *, void *), void *ctx) {
    if(!verify_api_session(ctrl, cb, ctx)) return;
    ...
    NEWP(verify_req, ziti_verify_extend_cert_authenticator_req);
