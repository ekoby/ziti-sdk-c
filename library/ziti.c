...
void ziti_set_client_cert(ziti_context ztx, const char *cert_buf, size_t cert_len, const char *key_buf, size_t key_len) {
    ztx->tlsCtx->api->set_own_cert(ztx->tlsCtx, cert_buf, cert_len, key_buf, key_len);
}
